...
function downloadTemplate() {
   yml=$1
   repo="https://raw.githubusercontent.com/cavecafe/k8s-template/main/spring-boot/k8s"
   if [ -f "$yml" ]; then
     echo "$yml exists"
   else
...
deploy_url="https://raw.githubusercontent.com/kubernetes/ingress-nginx/$latest_version/deploy/static/provider/cloud/deploy.yaml"
